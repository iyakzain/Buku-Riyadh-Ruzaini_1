  ...
  <div class="container-sm d-block position-relative m-auto" style="height: 100vh; width:50vh">
    <div class="container-sm d-inline-flex " style="height: 100%; width: 100%">
      <div class="card o-hidden border-0 shadow-lg d-block m-auto" style="width: 100%">
        <div class="card-body p-0" style="height: 45vh">
          <div class="col-12">
            <div class="p-4">
              <div class="text-center">
                <h1 class="h4 text-gray-900" style="margin-bottom: 3rem">Salamat Datang</h1>
              </div>
              <form action="/auth" method="POST" class="user">
                @csrf
                {{ csrf_field() }}
                <div class="form-group">
                  <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror"
                    id="email" name="email" aria-describedby="emailHelp" placeholder="Enter Email Address..." required>
                  @error('email')
